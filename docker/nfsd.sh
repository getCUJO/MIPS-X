...
# --exports-file /etc/exports
    ...
    #echo "Starting QEMU"
    #/armx/run/qemu-system-arm-5.2.0 -monitor unix:qemu-monitor-socket,server,nowait -M versatilepb  -m 128M -kernel /armx/TRI227WF/kernel/zImage-2.6.28-versatile-nothumb  -drive file=/armx/hostfs/hostfs.ext2,if=scsi  -append "root=/dev/sda rw console=ttyAMA0,115200 ARMX=TRI227WF" -net nic -net tap,ifname=tap0,script=no,downscript=no  -nographic
    #echo "QEMU starting in background"
